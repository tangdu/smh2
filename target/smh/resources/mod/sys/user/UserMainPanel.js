...
Ext.define('Sys.user.UserList',{
    ...
    initComponent:function(){
        ...
        this.bbar=Ext.create('Ipe.PagingToolbar',{
            ...
            items:pageCom([['userName','用户名'],['userAccount','用户帐号']],this)
        });
        this.callParent();
    },delUser:function(){
        var me=this;
...
Ext.define('Sys.user.userEditForm',{
    ...
    initComponent:function(){
        this.items=[{
         ...
         fieldLabel:'密码',xtype:'textfield',name:'password1',allowBlank:false,inputType:'password',
         listeners:{
         scope:this,
         change:this.pwdChange
         }
         },{
         fieldLabel:'重复密码',xtype:'textfield',name:'password2',allowBlank:false,inputType:'password'
         },*/{
            ...
            fieldLabel:'是否超级管理员',xtype:'combo',name:'admin',store:ipe.store.flagStore,originalValue:'0',
