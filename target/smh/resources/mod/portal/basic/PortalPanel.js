...
Ext.define('Pot.basic.PortalPanel', {
    ...
    /*requires: [
        ...
        'Pot.basic.PortalDropZone',
        'Pot.basic.PortalColumn'
    ],*/
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('Pot.basic.PortalDropZone', this, this.dropConfig);
    },
