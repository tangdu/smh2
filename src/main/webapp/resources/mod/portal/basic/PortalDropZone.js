/**
 * @class Desktop.portal.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link Desktop.portal.PortalPanel}.
 */
Ext.define('Pot.basic.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',
    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        Pot.basic.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        Pot.basic.PortalDropZone.superclass.unreg.call(this);
    }
});
