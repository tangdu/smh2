Ext.define('Sys.menu.MenuTreePanel',{
    ...
    initComponent:function(){
        ...
        this.columns=[{xtype: 'rownumberer'},{
            ...
            text:'状态',dataIndex:'enabled',renderer:ipe.fuc.flagDt
        }];
        ...
        if(record && record.length>0){
            ...
            parent.menuForm.setPid(record[0].data.id);
        }else{
        ...
        if(record && record.length>0){
            ...
            parent.menuForm.setPid(record[0].data.parentId);
        }else{
...
Ext.define('Sys.menu.MenuForm',{
    ...
    initComponent:function(){
        this.items=[{
            ...
            fieldLabel:'菜单类型',name:'menuType',allowBlank:false,xtype:'combo',store:ipe.store.menuStore,originalValue:'1',
        ...
        if(record.data.resource){
            ...
            this.getForm().findField('resource.id').setValue(record.data.resource.id);
        }
